...
find ./NEWMODULE -type f -exec sed -i "s|NEWMATH|${MODULENAME}|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|MOD_NEWMATH_|MOD_${MODULENAME}_|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|newmath|${LMODULENAME}|g" {} \;
printf "enter the year, your name and email address on one line for the copyright notice. eg 2015 John Doe jdoe@email.com \n" 
read 2017 See Lok Kan
find ./NEWMODULE -type f -exec sed -i "s|2017 See Lok Kan|${2017 See Lok Kan}_|g" {} \; 
