...
$string['modulename'] = 'newmath';
$string['modulenameplural'] = 'newmaths';
$string['modulename_help'] = 'newmath help';
$string['newmathfieldset'] = 'Custom example fieldset';
$string['newmathname'] = 'newmath name';
$string['newmathname_help'] = 'This is the content of the help tooltip associated with the newmathname field. Markdown syntax is supported.';
$string['newmath'] = 'newmath';
$string['pluginadministration'] = 'newmath Administration';
$string['pluginname'] = 'newmath Activity';
...
$string['newmathsettings'] = 'newmath settings';
$string['newmath:addinstance'] = 'Add a new newmath';
$string['newmath:view'] = 'View newmath';
$string['newmath:preview'] = 'Preview newmath';
$string['newmath:itemview'] = 'View items';
$string['newmath:itemedit'] = 'Edit items';
$string['id']='ID';
$string['name']='Name';
...
$string['newmathtask'] ='newmath Task';
