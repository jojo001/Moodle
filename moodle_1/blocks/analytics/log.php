...
// Some stuff.
$url = new moodle_url('/blocks/analytics/log.php', array('courseid' => $courseid));
$strcoursereport = get_string('courselog', 'block_analytics');
...
$table = new block_analytics_log_table('block_analytics_log', $courseid, $group);
