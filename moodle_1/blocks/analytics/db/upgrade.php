...
function xmldb_block_analytics_upgrade($oldversion) {
    ...
    if ($oldversion < 2014031500) {
        ...
        // Define field enabled to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        upgrade_block_savepoint(true, 2014031500, 'analytics');
    }

    if ($oldversion < 2014072301) {

        // Define field enableladder to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014072301, 'analytics');
    }

    if ($oldversion < 2014072401) {

        // Define field levelsdata to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014072401, 'analytics');
    }

    if ($oldversion < 2014072402) {

        // Define field enableinfos to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014072402, 'analytics');
    }

    if ($oldversion < 2014072403) {

        // Define index courseid (unique) to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014072403, 'analytics');
    }

    if ($oldversion < 2014090800) {

        // Define field enablelevelupnotif to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014090800, 'analytics');
    }

    if ($oldversion < 2014090900) {

        // Define table block_analytics_filters to be created.
        $table = new xmldb_table('block_analytics_filters');

        // Adding fields to table block_analytics_filters.
        ...
        // Adding keys to table block_analytics_filters.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Adding indexes to table block_analytics_filters.
        $table->add_index('courseid', XMLDB_INDEX_NOTUNIQUE, array('courseid'));

        // Conditionally launch create table for block_analytics_filters.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014090900, 'analytics');
    }

    if ($oldversion < 2014091200) {

        // Define field enablecustomlevelbadges to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2014091200, 'analytics');
    }

    if ($oldversion < 2015030901) {

        // Define field maxactionspertime to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2015030901, 'analytics');
    }

    if ($oldversion < 2015030902) {

        // Define field timeformaxactions to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2015030902, 'analytics');
    }

    if ($oldversion < 2015030903) {

        // Define field timebetweensameactions to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2015030903, 'analytics');
    }
    ...
    if ($oldversion < 2016021500) {
        ...
        $DB->delete_records('user_preferences', array('name' => 'block_analytics_notify_level_up'));

        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016021500, 'analytics');
    }

    if ($oldversion < 2016021501) {

        // Define field identitymode to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016021501, 'analytics');
    }

    if ($oldversion < 2016021502) {

        // Define field rankmode to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016021502, 'analytics');
    }

    if ($oldversion < 2016021503) {

        // Define field neighbours to be added to block_analytics_config.
        $table = new xmldb_table('block_analytics_config');
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016021503, 'analytics');
    }
    ...
    if ($oldversion < 2016022401) {
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016022401, 'analytics');
    }
    ...
    if ($oldversion < 2016022402) {
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016022402, 'analytics');
    }
    ...
    if ($oldversion < 2016022403) {
        ...
        // Xp savepoint reached.
        upgrade_block_savepoint(true, 2016022403, 'analytics');
    }
