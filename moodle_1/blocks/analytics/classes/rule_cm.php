 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_analytics_rule_cm extends block_analytics_rule_property {
    ...
    public function get_description() {
        ...
        $contextname = get_string('errorunknownmodule', 'block_analytics');
        if ($context) {
            $contextname = $context->get_context_name();
        }
        return get_string('rulecmdesc', 'block_analytics', (object)array(
    ...
    public function get_form($basename) {
        ...
        $o .= get_string('activityoresourceis', 'block_analytics', $modules);
        return $o;
    }
