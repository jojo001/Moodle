...
/**
 * block_analytics user leveled up event.
 *
...
namespace block_analytics\event;
defined('MOODLE_INTERNAL') || die();

/**
 * block_analytics user leveled up event class.
 *
 * @package    block_analytics
 * @copyright  2014 Frédéric Massart
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class user_leveledup extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_leveledup', 'block_analytics');
    }
    ...
    public function get_url() {
        return new \moodle_url('/block_analytics/report.php', array('courseid' => $this->courseid));
    }
