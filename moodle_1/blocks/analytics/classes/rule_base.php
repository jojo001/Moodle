 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class block_analytics_rule_base extends block_analytics_rule {
    ...
    protected function get_compare_select($basename) {
        return html_writer::select(array(
                block_analytics_rule_base::CT => get_string('rule:' . block_analytics_rule_base::CT, 'block_analytics'),
                block_analytics_rule_base::EQ => get_string('rule:' . block_analytics_rule_base::EQ, 'block_analytics')
