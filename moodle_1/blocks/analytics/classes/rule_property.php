 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_analytics_rule_property extends block_analytics_rule_base {
    ...
    public function get_description() {
        return get_string('rulepropertydesc', 'block_analytics', (object)array(
            'property' => $this->property,
            'compare' => get_string('rule:' . $this->compare, 'block_analytics'),
            'value' => $this->value
        ));
    }
    ...
    public function get_form($basename) {
        ...
        $o .= html_writer::select(array(
                'eventname' => get_string('property:eventname', 'block_analytics'),
                'component' => get_string('property:component', 'block_analytics'),
                'action' => get_string('property:action', 'block_analytics'),
                'target' => get_string('property:target', 'block_analytics'),
                'crud' => get_string('property:crud', 'block_analytics'),
