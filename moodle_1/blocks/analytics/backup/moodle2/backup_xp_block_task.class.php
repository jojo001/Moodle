...
require_once($CFG->dirroot . '/blocks/analytics/backup/moodle2/backup_analytics_stepslib.php');
...
class backup_analytics_block_task extends backup_block_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_analytics_block_structure_step('analytics', 'analytics.xml'));
    }
