...
require_once($CFG->dirroot . '/blocks/analytics/backup/moodle2/restore_analytics_stepslib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_analytics_block_task extends restore_block_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new restore_analytics_block_structure_step('analytics', 'analytics.xml'));
    }
