YUI.add('moodle-block_analytics-rulepicker', function (Y, NAME) {
 ...
 *
 * @module     moodle-block_analytics-rulepicker
 * @package    block_analytics
 * @copyright  2014 Frédéric Massart
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       moodle-block_analytics-rulepicker
 */
...
var NAME = 'moodle-block_analytics-rulepicker';
var COMPONENT = 'block_analytics';
var CSS = {
    PREFIX: 'block_analytics-rulepicker',
    RULE: 'rule',
};
var SELECTORS = {
    RULE: '.rule button'
...
Y.namespace('M.block_analytics').RulePicker = Y.extend(PICKER, M.core.dialogue, {
...
Y.Base.modifyAttrs(Y.namespace('M.block_analytics.RulePicker'), {
...
Y.namespace('M.block_analytics.RulePicker').init = function(config) {
