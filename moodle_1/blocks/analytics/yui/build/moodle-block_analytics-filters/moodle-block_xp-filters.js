YUI.add('moodle-block_analytics-filters', function (Y, NAME) {
 ...
 * Filters constants.
 *
 * @module     moodle-block_analytics-filters
 * @package    block_analytics
 * @copyright  2015 Frédéric Massart
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       moodle-block_analytics-filters
 */
...
var CSS = {
    ...
    PREFIX: 'block_analytics-filters',
    RULE: 'rule',
    RULES: 'rule-rules',
};
var SELECTORS = {
    ...
    CONTAINER: '.block-analytics-filters',
...
var NAME = 'moodle-block_analytics-filters';
...
Y.namespace('M.block_analytics').Filters = Y.extend(FILTERS, Y.Base, {
    ...
    initializer: function() {
        ...
        this.filterDnD = Y.namespace('M.block_analytics.Filters.DnD').init({
    ...
    prepareRuleDialog: function() {
        ...
        this.rulepicker = Y.namespace('M.block_analytics.RulePicker').init({
            rules: rules
        });
    ...
    setFilterRulesDnD: function(filterNode) {
        this.rulesDnD[filterNode.generateID()] = Y.namespace('M.block_analytics.Filters.DnD').init({
...
Y.namespace('M.block_analytics.Filters').init = function(config) {
 ...
 * Filters Drag and Drop.
 *
 * @namespace Y.M.block_analytics.Filters.DnD
 * @class DnD
 * @constructor
 */
var DND = function() {
...
Y.namespace('M.block_analytics.Filters').DnD = Y.extend(DND, M.core.dragdrop, {
    ...
    NAME: 'block_analytics-filters-dnd',
    ATTRS: {
...
Y.namespace('M.block_analytics.Filters.DnD').init = function(config) {
    return new DND(config);
};


}, '@VERSION@', {"requires": ["base", "node", "moodle-core-dragdrop", "moodle-block_analytics-rulepicker"]});
