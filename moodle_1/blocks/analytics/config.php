...
// Some stuff.
$url = new moodle_url('/blocks/analytics/config.php', array('courseid' => $courseid));
$strcoursesettings = get_string('coursesettings', 'block_analytics');
...
$form = new block_analytics_settings_form($url->out(false), array('defaultconfig' => block_analytics_manager::get_default_config()));
