...
$string['addrulesformhelp'] = 'The last column defines the amount of eanalyticserience points gained when the criteria is met.';
...
$string['awardaanalyticswhen'] = '<strong>{$a}</strong> eanalyticserience points are earned when:';
$string['baseanalytics'] = 'Algorithm base';
...
$string['coefanalytics'] = 'Algorithm coefficient';
...
$string['defaultrulesformhelp'] = 'Those are the default rules provided by the plugin, they automatically give default eanalyticserience points and ignore some redundant events. Your own rules take precedence over them.';
...
$string['enableanalyticsgain'] = 'Enable XP gain';
$string['enableanalyticsgain_help'] = 'When set to \'No\', nobody will earn eanalyticserience points in the course. This is useful to freeze the eanalyticserience gained, or to enable it at a certain point in time.

Please note that this can also be controlled more granularly using the capability \'block/analytics:earnanalytics\'.';
...
$string['erroranalyticsrequiredlowerthanpreviouslevel'] = 'The XP required is lower than or equal to the previous level.';
...
$string['invalidanalytics'] = 'Invalid XP value';
...
$string['participatetolevelup'] = 'Participate in the course to gain eanalyticserience points and level up!';
$string['rank'] = 'Rank';
$string['ranking'] = 'Ranking';
$string['ranking_help'] = 'The rank is the absolute position of the current user in the ladder. The relative rank is the difference in eanalyticserience points between a user and their neighbours.';
$string['reallyresetdata'] = 'Really reset the levels and eanalyticserience points of everyone in this course?';
$string['reallyresetgroupdata'] = 'Really reset the levels and eanalyticserience points of everyone in this group?';
...
$string['rulesformhelp'] = '<p>This plugin is making use of the events to attribute eanalyticserience points to actions performed by the students. You can use the form below to add your own rules and view the default ones.</p>
...
<ul>
    ...
    <li>The actions performed by users not having the capability <em>block/analytics:earnanalytics</em>.</li>
...
$string['whereareanalyticsused'] = 'Where are eanalyticserience points used?';
$string['whereareanalyticsused_desc'] = 'When set to \'In courses\', the eanalyticserience points gained will only account for the course in which the block was added to. When set to \'For the whole site\', a user will "level up" in the site rather than selectively per course, all the eanalyticserience gained throughout the site will be used.';
...
$string['when'] = 'When';
$string['analytics'] = 'Eanalyticserience points';
$string['analytics:addinstance'] = 'Add a new XP block';
$string['analytics:earnanalytics'] = 'Earning eanalyticserience points';
$string['analytics:myaddinstance'] = 'Add the block to my dashboard';
$string['analytics:view'] = 'View the block and its related pages';
$string['analyticsrequired'] = 'XP required';
$string['analyticsgaindisabled'] = 'XP gain disabled';
