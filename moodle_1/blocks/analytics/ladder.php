...
// Some stuff.
$url = new moodle_url('/blocks/analytics/ladder.php', array('courseid' => $courseid));
$strladder = get_string('ladder', 'block_analytics');
...
$table = new block_analytics_ladder_table('block_analytics_ladder', $courseid, $group, array(
