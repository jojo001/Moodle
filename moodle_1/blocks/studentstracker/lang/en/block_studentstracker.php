...
$string['block_studentstracker_text_header'] = 'Text near the users counter';
$string['block_studentstracker_text_header_fine'] = 'Text when everything\'s fine';
$string['block_studentstracker_text_never'] = 'Text when no access at all';
$string['block_studentstracker_text_footer'] = 'Footer text';
