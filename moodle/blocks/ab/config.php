...
// Some stuff.
$url = new moodle_url('/blocks/ab/config.php', array('courseid' => $courseid));
$strcoursesettings = get_string('coursesettings', 'block_ab');
...
$form = new block_ab_settings_form($url->out(false), array('defaultconfig' => block_ab_manager::get_default_config()));
