...
$string['addrulesformhelp'] = 'The last column defines the amount of eaberience points gained when the criteria is met.';
...
$string['awardaabwhen'] = '<strong>{$a}</strong> eaberience points are earned when:';
$string['baseab'] = 'Algorithm base';
...
$string['coefab'] = 'Algorithm coefficient';
...
$string['defaultrulesformhelp'] = 'Those are the default rules provided by the plugin, they automatically give default eaberience points and ignore some redundant events. Your own rules take precedence over them.';
...
$string['enableabgain'] = 'Enable XP gain';
$string['enableabgain_help'] = 'When set to \'No\', nobody will earn eaberience points in the course. This is useful to freeze the eaberience gained, or to enable it at a certain point in time.

Please note that this can also be controlled more granularly using the capability \'block/ab:earnab\'.';
...
$string['errorabrequiredlowerthanpreviouslevel'] = 'The XP required is lower than or equal to the previous level.';
...
$string['invalidab'] = 'Invalid XP value';
...
$string['levelup'] = 'Back up Level up!';
...
$string['participatetolevelup'] = 'Participate in the course to gain eaberience points and level up!';
$string['rank'] = 'Rank';
$string['ranking'] = 'Ranking';
$string['ranking_help'] = 'The rank is the absolute position of the current user in the ladder. The relative rank is the difference in eaberience points between a user and their neighbours.';
$string['reallyresetdata'] = 'Really reset the levels and eaberience points of everyone in this course?';
$string['reallyresetgroupdata'] = 'Really reset the levels and eaberience points of everyone in this group?';
...
$string['rulesformhelp'] = '<p>This plugin is making use of the events to attribute eaberience points to actions performed by the students. You can use the form below to add your own rules and view the default ones.</p>
...
<ul>
    ...
    <li>The actions performed by users not having the capability <em>block/ab:earnab</em>.</li>
...
$string['whereareabused'] = 'Where are eaberience points used?';
$string['whereareabused_desc'] = 'When set to \'In courses\', the eaberience points gained will only account for the course in which the block was added to. When set to \'For the whole site\', a user will "level up" in the site rather than selectively per course, all the eaberience gained throughout the site will be used.';
...
$string['when'] = 'When';
$string['ab'] = 'Eaberience points';
$string['ab:addinstance'] = 'Add a new XP block';
$string['ab:earnab'] = 'Earning eaberience points';
$string['ab:myaddinstance'] = 'Add the block to my dashboard';
$string['ab:view'] = 'View the block and its related pages';
$string['abrequired'] = 'XP required';
$string['abgaindisabled'] = 'XP gain disabled';
