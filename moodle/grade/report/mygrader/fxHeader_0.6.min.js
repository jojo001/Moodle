...
b.innerHTML=
 '<div id="'+c+':scroller:fx" style="text-align:left;position:relative;width:9999px;padding:0px;margin-left:0px;"></div>';
//<font size="3" color="red">Please wait while loading the table..</font>
var h=null;0<i&&(h=document.createElement("div"),h.id=c+":scroller:fxcol",h.style.cssText="width:0px;height:auto;display:block;float:left;overflow:hidden;",h.innerHTML="<div id='"+c+":scroller:fxCH' style='width:100%;overflow:hidden;'>&nbsp;</div><div id='"+c+":scroller:fxCB' style='width:100%;overflow:hidden;'>&nbsp;</div>");
