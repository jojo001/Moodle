...
/*
    $settings->add(new admin_setting_configcheckbox('grade_report_showzerofill', get_string('showzerofill', 'gradereport_allgrader'),
                                                '', 1));
*/
    // $settings->add(new admin_setting_configcheckbox('grade_report_showclearoverrides', get_string('showclearoverrides', 'gradereport_allgrader'),
    //                                             '', 1));
    ...
    $settings->add(new admin_setting_configselect('grade_report_rangesdecimalpoints', get_string('rangesdecimalpoints', 'grades'),
                                              ...
                                              array(GRADE_REPORT_PREFERENCE_INHERIT => $strinherit,
                                                     ...
                                                     '4' => '4',
                                                     '5' => '5')));
	//$settings->add(new admin_setting_configcheckbox('grade_report_allgrader_accuratetotals', get_string('accuratetotals', 'gradereport_allgrader'), get_string('configaccuratetotals', 'gradereport_allgrader'), 2, PARAM_INT));
                                              
    $settings->add(new admin_setting_configcheckbox('grade_report_allgrader_extrafields', get_string('allgrader_extrafields', 'gradereport_allgrader'), get_string('allgrader_extrafields_help', 'gradereport_allgrader'), 0));
	$options = array(
			...
			14 => '860',
			15 => '900');
    $settings->add(new admin_setting_configselect('grade_report_allgrader_reportheight', get_string('allgrader_reportheight', 'gradereport_allgrader'), null, 8, $options));
	$options = array(
			...
			12 => '85',
			13 => '90');
    $settings->add(new admin_setting_configselect('grade_report_allgrader_columnwidth', get_string('allgrader_columnwidth', 'gradereport_allgrader'), null, 0, $options));
}
