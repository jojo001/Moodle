...
/**
 * Strings for component 'allgradereport_grader', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   allgradereport_grader
 * @copyright 2010 onwards Bob Puffer
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['accuratetotals'] = 'Accurate POINT TOTALS (Maths User report should be used also if Accurate Points is turned on so report totals agree - available at http://github.com/bobpuffer/alluser.git)';
...
$string['allgrader_columnwidth'] = 'Number of characters wide before grade titles wrap';
$string['allgrader_extrafields'] = 'Show extra user fields';
$string['allgrader_extrafields_help'] = 'Show extra user fields (such as user email or user idnumber -- as set by a site administrator in user policies) in the grader report';

$string['allgrader_reportheight'] = 'Height (in pixels) of scrollable portion of Maths grader report';
$string['allgrader:view'] = 'View the Maths grader report';
$string['pluginname'] = 'Maths Grader Report';
$string['preferences'] = 'Maths Grader report preferences';
